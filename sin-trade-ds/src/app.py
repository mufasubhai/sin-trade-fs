...
from src.services.ds_job_scheduler import  check_targets, keep_backend_alive, run_ml_trading_cron, compute_ticker_stats
...
if __name__ == "src.app":
    try:
        ...
        scheduler.add_job(keep_backend_alive, "interval", minutes=20)
        scheduler.add_job(run_ml_trading_cron, "cron", minute=0)
        scheduler.add_job(compute_ticker_stats, "cron", minute=0)
        declare_queues()
        subscribe_to_queues()
        scheduler.start()
